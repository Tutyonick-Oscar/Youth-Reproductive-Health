...
<head>
    ...
    <title>We have problem loading this page</title>
</head>
<body>
<div class="flex items-center justify-center w-full h-screen px-16 bg-[#80808057] md:px-0">
    <div class="flex flex-col items-center justify-center px-4 py-8 bg-white border border-gray-200 rounded-lg shadow-2xl md:px-8 lg:px-24">
        <p class="text-6xl font-bold tracking-wider text-[#80808057] md:text-7xl lg:text-9xl">500</p>
        <p class="mt-4 text-2xl font-bold tracking-wider text-accent1 md:text-3xl lg:text-5xl">Something went wrong </p>
        <p class="pb-4 mt-4 text-center border-b-2 text-[#8080807c]">Sorry, We have problem loading this page try to reload or</p>
