...
@section('content')
    ...
    <section
        ...
        <div style="background-image:url(/store/{{$blog->image}})"
            ...
            <p class="hidden md:flex text-2xl font-semibold text-white">Description du blog</p>
            <span class="hidden md:flex font-semibold text-accent1">
                YRHealth / {{$blog->title}}
            </span>
        </div>
    </section>
    <section class="flex flex-col w-full gap-10 px-8 lg:flex-row">
        <div class="blogs w-full lg:w-[65%] flex flex-col gap-6 pt-10">
            <div class="flex flex-col w-full h-auto gap-6 md:px-8 py-8 bg-white md:rounded-md md:shadow-lg blog">
                <h1 class="hidden md:flex text-3xl text-bg">
                    {{$blog->title}}
                </h1>
                   ...
                   @forelse ($recentBlogs as $recent)
                        ...
                        <div class="recent-blog w-full flex gap-4 items-center pb-4 border-b border-[#80808032]">
                            <div class=" w-[25%] h-[5.3rem] ">
                                <img loading="lazy" decoding="async"  src="{{asset('images/lazy.jpg')}}" data-src="/store/{{$recent->image}}" alt="article" width="80" height="80"
