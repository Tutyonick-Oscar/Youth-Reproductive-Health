...
@section('title','Youth Reproductive Health | donations')
@section('content')
<div class="w-full md:flex h-auto">
  ...
  <div class="flex-1 main">
   ...
   <section class=" flex flex-col gap-4 py-5 px-8">
    <div class=" w-full">
        <p> Accueil / Gestionnaire des dons</p>
    </div>
    <div class=" flex flex-col gap-6 w-full">
        <h1 class=" text-2xl">
            GESTIONNAIRE DES DONS
        </h1>
    </div>
   </section>
        ...
        <table class=" dash-border rounded-[4px]">
            <thead class=" border-b  dash-border">
                <tr class="">
                    ...
                    <th class=" w-[20%] border-r dash-border">Donateur</th>
                    <th class="w-[12%] border-r dash-border">numero</th>
                    <th class="w-[20%] border-r dash-border">E-mail</th>
                    <th class="w-[15%] border-r dash-border">Montant</th>
            ...
            <tbody>
                <tr class="h-[2rem]">
                    ...
                    <td class="w-[20%] border-r dash-border text-center py-2 h-[50px] px-4"> 
                        Donnateur 1
                    </td>
                    <td class="w-[12%] border-r dash-border text-center "> 0973833744 </td>
                    <td class="w-[20%] border-r dash-border text-center "> tuliamtendji@gmail.com </td>
                    <td class="w-[15%] border-r dash-border text-center "> 1000 $ </td>
