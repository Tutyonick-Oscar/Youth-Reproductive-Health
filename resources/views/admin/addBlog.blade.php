  ...
  <div class="flex-1 main">
    ...
    <section class=" flex flex-col gap-4 py-5 px-8">
       ...
       <section class="w-full flex flex-col gap-4 pb-5 px-8">
        <form id="form" action="" class="w-full flex gap-10 items-center h-[25.75rem] justify-center" enctype="multipart/form-data">
            <div id="klk" class="flex flex-col gap-4 h-full ">
                ...
                <div class=" w-full flex gap-2 px-4 py-4 rounded-[4px] bg-[#fff] items-center">
                    <label for="title" class="text-bg text-base font-bold">date : </label>
                    <input type="text" class=" outline-none duration-300 ease-in-out dash-border rounded-[4px] px-4 py-1 focus:border-accent1">
                </div>
                <div class=" w-full flex gap-2 px-4 py-4 rounded-[4px] bg-[#fff] items-center">
                    <label for="title" class="text-bg text-base font-bold">Type : </label>
                    <input type="text" class=" outline-none duration-300 ease-in-out dash-border rounded-[4px] px-4 py-1 focus:border-accent1">
                </div>
            </div>
            <div class="w-[70%] flex flex-col gap-3 h-[25.75rem]">
                ...
                <div class=" w-full flex gap-2 px-4 py-4 rounded-[4px] bg-[#fff] items-center">
                    <label for="title" class="text-bg text-base font-bold">Tags : </label>
                    <div id="tagsDiv" class=" flex gap-2">
                        <input type="text" autofocus id="tags" name="tags"
